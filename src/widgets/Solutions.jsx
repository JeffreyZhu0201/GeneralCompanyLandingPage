...
function Solutions() {
    return (
        <>
            <div>
                <SectionHeading title="解决方案" subTitle="解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案" />
            </div>
            <div className='grid lg:grid-cols-2 mt-20 gap-20'>
                <div className=''>
                    <h3 className='mt-7 text-[32px] font-fold'>强有力工具</h3>
                    <p className='mt-4 mb-8 text-gray-500'>解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案解决方案</p>
                    <ul className='grid gap-3'>
                        {
                            [1, 2, 3].map((item, key) => (
                                <li key={key} className={`p-5  justify-between rounded border border-zinc-100 ${item === 1 && "bg-zinc-100"}`}>
                                    <p className='text-lg font-bold'>构建简单的生态系统</p>
                                    <div className='flex justify-between relative'>
                                        <p className='text-lg leading-7 mt-1'>
                                            构建简单的生态系统构建简单的生态系统构建简单的生态系统构建简单的生态系统v
                                        </p>
                                        <svg
                                            width="38"
                                            height="38"
