...
function Hero() {
    return (
        <div className='grid justify-items-center gap-8 pb-28 relative'>
            <p className='text-4xl md:text-6xl font-black text-center leading-normal'>We are the best</p>
            <p className='text-xl text-gray-700 md:w-1/2 text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi, voluptates.Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi, voluptates.</p>

            <div>
                <button className='rounded bg-blue-500 text-base text-white py-3 px-8'>立即试用</button>
                <button className='rounded bg-gray-900 text-base text-white py-3 px-8 ml-4'>了解更多</button>
            </div>
