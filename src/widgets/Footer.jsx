  ...
  return (
    <footer className="grid gap-8 md:gap-0 text-gray-500 md:w-4/5 mx-auto mt-32 md:grid-cols-5">
      <div className="w-full justify-center flex flex-col">
        <img src={Logo} alt="" className="w-6 h-8 mx-auto mb-8" />
        <div className="flex flex-row justify-center gap-3 text-black text-lg">
          <a href="#" className="block">协议</a>.<a href="#">隐私</a>
        </div>
      </div>
      {[1, 2, 3].map((v) => (
        <nav key={v} className="grid gap-2 content-start">
